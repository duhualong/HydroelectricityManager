 ...
 * 邮箱2383335125@qq.com
 */
public class ServiceDemandActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_demand_test);
